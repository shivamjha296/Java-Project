    ...
    public Controller(Model m, View v)
    {
        ...
        view.getMbf().getBooking_ip().getEbp().getGetBookingBtn().addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                model.getMb().readBookingsJsonFile("Exp11/src/Model/Bookings/Bookings.json");
        ...
        view.getMbf().getBooking_ip().getDbp().getDeleteBookingBtn().addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                String txt_booking_idx = view.getMbf().getBooking_ip().getDbp().getTxt_del_booking_id().getText();
                try {
                    model.getMb().deleteBooking(Integer.valueOf(txt_booking_idx));
                } catch (IOException ex) {
                    throw new RuntimeException(ex);
                }
            }
